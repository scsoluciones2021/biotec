...
public class FichaDTO implements Serializable {
    ...
    private String pacienteApellidoPaciente;
    ...
    public String getPacienteApellidoPaciente() {
        return pacienteApellidoPaciente;
    }

    public void setPacienteApellidoPaciente(String pacienteApellidoPaciente) {
        this.pacienteApellidoPaciente = pacienteApellidoPaciente;
    }
    ...
    public String toString() {
        return "FichaDTO{" +
            ...
            ", paciente='" + getPacienteApellidoPaciente() + "'" +
