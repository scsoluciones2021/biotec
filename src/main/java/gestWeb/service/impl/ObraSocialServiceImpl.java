...
import gestWeb.repository.ObraSocialRepository;
import gestWeb.service.dto.ObraSocialDTO;
import gestWeb.service.mapper.ObraSocialMapper;
...
public class ObraSocialServiceImpl implements ObraSocialService {
    ...
    @Override
    public Page<ObraSocialDTO> findObraSocial(String nombre, Pageable pageable) {
        Page<ObraSocialDTO> result = this.obraSocialRepository.findObraSocial(nombre, pageable).map(obraSocialMapper::toDto);
      return result;
    }
}
