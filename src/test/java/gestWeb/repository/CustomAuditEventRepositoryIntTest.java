...
import gestWeb.config.audit.AuditEventConverter;
import gestWeb.domain.PersistentAuditEvent;
...
import static gestWeb.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
