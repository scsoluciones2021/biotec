...
describe('Component Tests', () => {
    describe('ObsAntecFamiliar Management Component', () => {
        let comp: ObsAntecFamiliarComponent;
        let fixture: ComponentFixture<ObsAntecFamiliarComponent>;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ObsAntecFamiliarComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(ObsAntecFamiliarComponent);
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.obsAntecFamiliars[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
