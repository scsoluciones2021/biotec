    ...
    describe('Ficha Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/fichas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Ficha', () => {
                service.create(new Ficha(null)).subscribe(received => {
            ...
            it('should update a Ficha', () => {
                service.update(new Ficha(123)).subscribe(received => {
