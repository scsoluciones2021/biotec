...
describe('Component Tests', () => {
    describe('AdjuntosFicha Management Component', () => {
        let comp: AdjuntosFichaComponent;
        let fixture: ComponentFixture<AdjuntosFichaComponent>;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AdjuntosFichaComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(AdjuntosFichaComponent);
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.adjuntos_fichas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
