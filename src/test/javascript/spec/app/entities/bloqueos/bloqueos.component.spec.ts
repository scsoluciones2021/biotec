...
describe('Component Tests', () => {
    describe('Bloqueos Management Component', () => {
        let comp: BloqueosComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BloqueosComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.bloqueos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
