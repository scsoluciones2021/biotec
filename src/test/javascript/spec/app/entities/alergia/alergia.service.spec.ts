...
describe('Service Tests', () => {
    describe('Alergia Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AlergiaService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/alergias';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Alergia', () => {
                service.create(new Alergia(null)).subscribe(received => {
            ...
            it('should update a Alergia', () => {
                service.update(new Alergia(123)).subscribe(received => {
