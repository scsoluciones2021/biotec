    ...
    describe('Estados Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Estados', () => {
                service.create(new Estados(null)).subscribe(received => {
            ...
            it('should update a Estados', () => {
                service.update(new Estados(123)).subscribe(received => {
