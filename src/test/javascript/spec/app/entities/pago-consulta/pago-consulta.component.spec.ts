...
describe('Component Tests', () => {
    describe('PagoConsulta Management Component', () => {
        let comp: PagoConsultaComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PagoConsultaComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.pagoConsultas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
