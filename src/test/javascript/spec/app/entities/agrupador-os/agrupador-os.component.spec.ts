...
describe('Component Tests', () => {
    describe('AgrupadorOS Management Component', () => {
        let comp: AgrupadorOSComponent;
        let fixture: ComponentFixture<AgrupadorOSComponent>;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AgrupadorOSComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(AgrupadorOSComponent);
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.agrupadorOS[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
