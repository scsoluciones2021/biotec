...
import { HorariosProfesionalComponent } from 'app/entities/horarios-profesional/horarios-profesional.component';
...
describe('Component Tests', () => {
    describe('HorariosProfesional Management Component', () => {
        let comp: HorariosProfesionalComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(HorariosProfesionalComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new HorariosProfesional(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.horariosProfesionals[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
