...
describe('Service Tests', () => {
    describe('Regimen Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(RegimenService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/regimen';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Regimen', () => {
                service.create(new Regimen(null)).subscribe(received => {
            ...
            it('should update a Regimen', () => {
                service.update(new Regimen(123)).subscribe(received => {
