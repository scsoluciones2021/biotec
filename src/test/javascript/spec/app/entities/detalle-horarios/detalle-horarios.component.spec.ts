...
describe('Component Tests', () => {
    describe('DetalleHorarios Management Component', () => {
        let comp: DetalleHorariosComponent;
        let fixture: ComponentFixture<DetalleHorariosComponent>;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DetalleHorariosComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(DetalleHorariosComponent);
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.detalleHorarios[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
