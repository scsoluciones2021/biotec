...
describe('Service Tests', () => {
    describe('Enfermedad Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EnfermedadService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/enfermedads';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Enfermedad', () => {
                service.create(new Enfermedad(null)).subscribe(received => {
            ...
            it('should update a Enfermedad', () => {
                service.update(new Enfermedad(123)).subscribe(received => {
