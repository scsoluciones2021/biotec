    ...
    describe('AntecedentesPersonales Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/antecedentes-personales';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a AntecedentesPersonales', () => {
                service.create(new AntecedentesPersonales(null)).subscribe(received => {
            ...
            it('should update a AntecedentesPersonales', () => {
                service.update(new AntecedentesPersonales(123)).subscribe(received => {
            ...
            it('should return a AntecedentesPersonales', () => {
            ...
            it('should return a list of AntecedentesPersonales', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new AntecedentesPersonales(123)]);
            });
