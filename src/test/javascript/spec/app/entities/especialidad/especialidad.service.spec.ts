    ...
    describe('Especialidad Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/especialidads';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Especialidad', () => {
                service.create(new Especialidad(null)).subscribe(received => {
            ...
            it('should update a Especialidad', () => {
                service.update(new Especialidad(123)).subscribe(received => {
            ...
            it('should return a Especialidad', () => {
            ...
            it('should return a list of Especialidad', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Especialidad(123)]);
            });
