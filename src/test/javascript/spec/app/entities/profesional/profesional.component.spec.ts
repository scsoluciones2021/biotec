...
describe('Component Tests', () => {
    describe('Profesional Management Component', () => {
        let comp: ProfesionalComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ProfesionalComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.profesionals[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
