    ...
    describe('Profesional Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/profesionals';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Profesional', () => {
                service.create(new Profesional(null)).subscribe(received => {
            ...
            it('should update a Profesional', () => {
                service.update(new Profesional(123)).subscribe(received => {
            ...
            it('should return a Profesional', () => {
