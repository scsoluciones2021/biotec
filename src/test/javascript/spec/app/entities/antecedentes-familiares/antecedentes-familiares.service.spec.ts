    ...
    describe('AntecedentesFamiliares Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/antecedentes-familiares';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a AntecedentesFamiliares', () => {
                service.create(new AntecedentesFamiliares(null)).subscribe(received => {
            ...
            it('should update a AntecedentesFamiliares', () => {
                service.update(new AntecedentesFamiliares(123)).subscribe(received => {
            ...
            it('should return a AntecedentesFamiliares', () => {
            ...
            it('should return a list of AntecedentesFamiliares', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new AntecedentesFamiliares(123)]);
            });
