    ...
    describe('Diagnostico Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/diagnosticos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Diagnostico', () => {
                service.create(new Diagnostico(null)).subscribe(received => {
            ...
            it('should update a Diagnostico', () => {
                service.update(new Diagnostico(123)).subscribe(received => {
            ...
            it('should return a Diagnostico', () => {
