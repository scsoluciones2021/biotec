    ...
    describe('Personal Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/personals';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Personal', () => {
                service.create(new Personal(null)).subscribe(received => {
            ...
            it('should update a Personal', () => {
                service.update(new Personal(123)).subscribe(received => {
